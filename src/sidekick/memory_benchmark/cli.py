...
from sidekick.memory_benchmark.source import read_corpus, tencent_seed_payload
from sidekick.memory_benchmark.reporting import write_html_report
    ...
    try:
        if args.command == "generate-cases":
            ...
            _write_json(
                args.audit_output,
                {
                    "schema": "sidekick.memory-benchmark.case-validation.v1",
                    "model": client.model,
...
async def _run_quality(
    ...
    if args.output.exists():
        ...
        if (
            result.get("schema") != "sidekick.memory-benchmark.quality.v1"
        ...
        result = {
            "schema": "sidekick.memory-benchmark.quality.v1",
